...
# Usage: .\scripts\migrate-seed-standard.ps1

Write-Host "═══════════════════════════════════════" -ForegroundColor Cyan
Write-Host "Migration et Seed (scénario standard)" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    # Étape 2: Seed
    Write-Host "2️⃣  Peuplement de la base de données (standard)..." -ForegroundColor Yellow
    Write-Host ""
